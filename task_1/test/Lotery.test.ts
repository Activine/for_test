...
describe("NFT Sale", function () {
  ...
  describe("Main Logic", function () {
    ...
    //     .withArgs(oracleUSDT, contractUSDT);
    //   expect(await lottery.supportOfToken(contractBNB)).to.eq(true);
    //   await expect(txSetBNB).to.emit(lottery, "SetNewToken").withArgs(oracleBNB, contractBNB);
    // });
    ...
    //       owner
    //     );
    //     const txBuy = await lottery.connect(usdtKeeper).purchaseTicket(
    //       contractUSDT,
    //       1,
    //       amount,
    //       uri,
    ...
    //     const txBuy = await lottery.connect(bnbKeeper).purchaseTicket(
    //       contractBNB,
    //       2,
    //       amount,
    //       uri,
